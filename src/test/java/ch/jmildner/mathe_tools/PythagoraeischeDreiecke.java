...
public class PythagoraeischeDreiecke
{
    ...
    {
        MyTools.uebOut("Pythagoraeische Dreiecke - Start", 1);
        ...
        MyTools.uebOut("Pythagoraeische Dreiecke - Stopp", 1);
    }
    ...
    private void erstellen(int i) throws Exception
    {
        ...
        {
            String w1 = String.format("%10s %10s %10s",
                    "" + o1[0], "" + o1[1], "" + o1[2]);
            String w2 = String.format("%10s %10s %10s",
                    "" + o2[0], "" + o2[1], "" + o2[2]);
    ...
    private void erstellen2() throws Exception
    {
        ...
        MyTools.uebOut("erstellen2 " + MAX, 1);

        for (int i = 1; i <= MAX; i++)
        {
            int[] abc = TrigonometricTools
                    .getPythagoraeischeDreieckszahlen();
    ...
    private void erstellen1() throws Exception
    {
        ...
        MyTools.uebOut("erstellen1 " + MAX_I * MAX_J, 1);

        for (int i = 1; i <= MAX_I; i++)
        {
            for (int j = i + 1; j <= MAX_J + i; j++)
            {
                pythagoraeischeDreieckszahlen.add(TrigonometricTools
                        .getPythagoraeischeDreieckszahlen(i, j));
            }
        }
    }
    ...
    {
        MyTools.uebOut(
                "ausgeben: " + pythagoraeischeDreieckszahlen.size(), 1);
        ...
        String kFormat = s5 + s5 + s5 + s14 + s14 + s14 + s14 + s14
                + s14;
        String dFormat = d5 + d5 + d5 + f14 + f14 + f14 + f14 + f14
                + f14;
        String kopf = String.format(kFormat, "a", "b", "c", "Alpha",
                "Beta", "Gamma", "q", "p", "h");
        ...
        pythagoraeischeDreieckszahlen.stream().map((abc) ->
        {
            ...
            double alpha = TrigonometricTools
                    .getDegreesFromSin(da / dc);
            ...
            String zeile = String.format(dFormat, a, b, c, alpha, beta,
                    gamma, p, q, h);
            return zeile;
